const modules = {
  ...
  winMain: {
    ...
    download_audio_validator_path_get: 'download_audio_validator_path_get',
    download_audio_task_reset: 'download_audio_task_reset',
    download_audio_task_begin: 'download_audio_task_begin',
    download_audio_task_cancelled_get: 'download_audio_task_cancelled_get',
    download_audio_task_finish: 'download_audio_task_finish',
    download_audio_validate: 'download_audio_validate',
    download_audio_validate_cancel: 'download_audio_validate_cancel',

    song_organizer_capability_get: 'song_organizer_capability_get',
    ...
    song_organizer_playing_path_set: 'song_organizer_playing_path_set',
    song_organizer_download_occupancy_changed: 'song_organizer_download_occupancy_changed',
    song_organizer_organize_preview: 'song_organizer_organize_preview',
    song_organizer_organize_apply: 'song_organizer_organize_apply',
    song_organizer_recovery_get: 'song_organizer_recovery_get',
    song_organizer_recovery_rollback: 'song_organizer_recovery_rollback',
    song_organizer_recovery_dismiss: 'song_organizer_recovery_dismiss',
    flac_converter_capability_get: 'flac_converter_capability_get',
    flac_converter_artists_scan: 'flac_converter_artists_scan',
    flac_converter_preview: 'flac_converter_preview',
    flac_converter_apply: 'flac_converter_apply',
    flac_converter_pause_set: 'flac_converter_pause_set',
    flac_converter_progress: 'flac_converter_progress',
  },
  winLyric: {
    close: 'close',
    set_config: 'set_config',
